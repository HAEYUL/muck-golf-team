...
const STEPS = [
  ...
  {
    title: "🎵 먹회골프송",
    body: '입장하면 먹회골프송이 한 번 흘러나와요. 다른 화면으로 옮겨도 끝까지 이어져요. 이름 아래 "음악 끄기"나 화면 아래 음악 막대의 "끄기"로 끌 수 있고, 끈 휴대폰에서는 다음부터 자동으로 나오지 않아요. 다시 듣고 싶으면 "먹회골프송" 또는 홈 화면 아래 "먹회골프송 다시 듣기"를 눌러주세요.',
  },
];
